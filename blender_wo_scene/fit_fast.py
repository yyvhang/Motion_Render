...
for path in paths:
    ...
    keypoints_3d = torch.Tensor(data).to(device).float()
    ...
    vertices=outputp.vertices.detach().cpu().numpy()
    save_path = path.split('.')[0] + '_mesh.npy'
